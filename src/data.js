...
export const products = [
  { id:"amethyst-tumble", name:"Amethyst", cat:"Tumbled Stones", intent:"Calm",
    price:35, was:null, c1:"#9C6BD6", c2:"#5B2A9D", img:"/assets/amethyst.jpg",
  ...
  { id:"clear-quartz-tumble", name:"Clear Quartz", cat:"Tumbled Stones", intent:"Clarity",
    price:40, was:50, c1:"#E9F4FF", c2:"#A9C7DD", img:"/assets/clear-quartz.jpg",
  ...
  { id:"tigers-eye", name:"Tiger's Eye", cat:"Tumbled Stones", intent:"Confidence",
    price:35, was:null, c1:"#C8893C", c2:"#6E3F14", img:"/assets/tigers-eye.jpg",
  ...
  { id:"carnelian-tumble", name:"Carnelian", cat:"Tumbled Stones", intent:"Confidence",
    price:35, was:null, c1:"#E97D49", c2:"#B23E1C", img:"/assets/carnelian.jpg",
  ...
  { id:"lapis-lazuli", name:"Lapis Lazuli", cat:"Tumbled Stones", intent:"Clarity",
    price:60, was:null, c1:"#3F5FC0", c2:"#1E2F73", img:"/assets/lapis-lazuli.jpg",
  ...
  { id:"smoky-quartz-tumble", name:"Smoky Quartz", cat:"Tumbled Stones", intent:"Grounding",
    price:45, was:null, c1:"#9A8C84", c2:"#4A4038", img:"/assets/smoky-quartz-tumbled.jpg",
  ...
  { id:"black-tourmaline", name:"Black Tourmaline", cat:"Raw & Rough", intent:"Protection",
    price:45, was:null, c1:"#3A3A44", c2:"#111114", img:"/assets/black-tourmaline.jpg",
    blurb:"Shields against negativity. A grounding guardian.", stock:"In stock", tag:null },
  { id:"citrine-raw", name:"Citrine", cat:"Raw & Rough", intent:"Abundance",
    price:40, was:null, c1:"#FBD27A", c2:"#E0992F", img:"/assets/citrine.jpg",
    blurb:"Sunny stone of wealth, joy & new opportunity.", stock:"Low stock", tag:null },
  { id:"blue-calcite", name:"Blue Calcite", cat:"Raw & Rough", intent:"Calm",
    price:50, was:null, c1:"#BCD4E6", c2:"#8FB4D0", img:"/assets/blue-calcite.jpg",
  ...
  { id:"malachite-raw", name:"Malachite", cat:"Raw & Rough", intent:"Protection",
    price:95, was:null, c1:"#4FB07A", c2:"#16553A", img:"/assets/malachite.jpg",
    blurb:"Bold transformation & a fierce protective shield.", stock:"Low stock", tag:null },
  { id:"selenite-wand", name:"Selenite Wand", cat:"Points & Towers", intent:"Clarity",
    price:35, was:null, c1:"#F3EFE6", c2:"#CDBFA8", img:"/assets/selenite.jpg",
...
export const blogs = [
  ...
  },
  {
    ...
    body: [
      ...
      { list: [
        "Multi-Flash Uncut Ethiopian Opals — These are absolutely mesmerizing. Shimmering with a rainbow of colors trapped inside, uncut Ethiopian opals are beloved for their incredible play of color and mystical, high-vibrational energy. They are a favorite among collectors looking for something truly unique.",
        "Fire Agate — A stone of deep passion and fierce protection. Fire agate is highly sought after by those looking to light a fire under their ambitions. It provides a shield of absolute security while pushing you to take bold actions in your life.",
        "Dioptase on Matrix — A stunning, vibrant emerald-green showstopper. Dioptase is incredibly rare and highly prized. Beyond its breathtaking appearance on the matrix, it is widely considered one of the most powerful stones for deep heart-healing and emotional release.",
        "Moldavite — Known as the stone of rapid, undeniable transformation. Born from a meteorite impact, moldavite has a reputation for shaking up your life in the best way possible. It is highly sought after by those ready for intense, life-changing shifts.",
        "Malachite — The tough-love stone. Known for its gorgeous, hypnotic green swirls, malachite is a favorite for those ready to do the hard work. It is brilliant for clearing out toxic patterns, breaking bad habits, and ruthlessly encouraging positive change."
      ]},
      { p: "See something you love? Many of these crowd favorites sell out fast — keep an eye on the shop and our socials for restocks." }
    ]
  }
];
