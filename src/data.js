...
export const shopeeUrl = "https://shopee.ph/cheffyyyy";
export const tiktokUrl = "https://www.tiktok.com/@cheffyscrystals";

// Tags an outbound link to Shopee/TikTok so their own analytics can tell
// which spot on this site actually drove the click — every link out
...
export const intents = ["All", "Calm", "Protection", "Abundance", "Clarity", "Grounding", "Confidence", "Love"];
...
export const products = [
  { id:"amethyst-tumble", name:"Amethyst", cat:"Tumbled Stones", intent:"Calm",
    ...
    shopeePath:"CHEFFY-Amethyst-Tumbled-Crystals-Gemstones-i.1496634.40609185701" },
  { id:"clear-quartz-tumble", name:"Clear Quartz", cat:"Tumbled Stones", intent:"Clarity",
    ...
    shopeePath:"CHEFFY-Clear-Quartz-Crystal-Gemstone-Tumbled-i.1496634.14894628565" },
  { id:"tigers-eye", name:"Tiger's Eye", cat:"Tumbled Stones", intent:"Confidence",
    ...
    shopeePath:"CHEFFY-Tigers-Eye-Tumbled-Crystals-Gemstones-i.1496634.29620970397" },
  { id:"carnelian-tumble", name:"Carnelian", cat:"Tumbled Stones", intent:"Confidence",
    ...
    shopeePath:"CHEFFY-Carnelian-Crystal-Tumbled-Gemstone-i.1496634.12996181420" },
  { id:"lapis-lazuli", name:"Lapis Lazuli", cat:"Tumbled Stones", intent:"Clarity",
    ...
    shopeePath:"CHEFFY-Lapis-Lazuli-Gemstone-Crystals-i.1496634.24618259728" },
  { id:"smoky-quartz-tumble", name:"Smoky Quartz", cat:"Tumbled Stones", intent:"Grounding",
    ...
    shopeePath:"CHEFFY-Smoky-Quartz-Natural-Raw-Points-Medium-Crystals-i.1496634.48859766948" },
  ...
  { id:"citrine-raw", name:"Citrine", cat:"Raw & Rough", intent:"Abundance",
    ...
    shopeePath:"CHEFFY-Citrine-Points-Raw-Medium-H.Q-Crystal-Gemstone-i.1496634.47709748635" },
  { id:"blue-calcite", name:"Blue Calcite", cat:"Raw & Rough", intent:"Calm",
    ...
    shopeePath:"CHEFFY-Blue-Calcite-Crystal-Gemstone-i.1496634.20391548244" },
  { id:"malachite-raw", name:"Malachite", cat:"Raw & Rough", intent:"Protection",
    ...
    shopeePath:"CHEFFY-Malachite-Gravel-Crystals-Gemstones-SOLD-PER-PACK-(-5grms-)-i.1496634.47161931327" },
  ...
  { id:"selenite-plate", name:"Selenite Plate", cat:"Raw & Rough", intent:"Clarity",
    price:null, was:null, c1:"#F3EFE6", c2:"#CDBFA8", img:"/assets/selenite-plate.jpg",
    blurb:"Raw charging plate — set your other crystals on top to cleanse them.", stock:"In stock", tag:"New",
    shopeePath:"CHEFFY-Selenite-Crystal-Gemstone-Slabs-Plates-i.1496634.16388963586" },
  { id:"rose-quartz-tumble", name:"Rose Quartz", cat:"Tumbled Stones", intent:"Love",
    price:null, was:null, c1:"#F6A8C6", c2:"#D46A95", img:"/assets/rose-quartz.jpg",
    blurb:"The classic stone of love & self-worth. Soft, soothing energy.", stock:"In stock", tag:"New",
    shopeePath:"CHEFFY-Rose-Quartz-Crystal-Gemstone-Tumbled-Freeform-Cubes-i.1496634.18075202934" },
  { id:"green-aventurine-tumble", name:"Green Aventurine", cat:"Tumbled Stones", intent:"Abundance",
    price:null, was:null, c1:"#8FCB9B", c2:"#3E8B57", img:"/assets/green-aventurine.jpg",
    blurb:"Gentle luck & opportunity. A calm companion for new beginnings.", stock:"In stock", tag:"New",
    shopeePath:"CHEFFY-Aventurine-mini-tumbled-crystals-gemstones-SOLD-PER-PACK-i.1496634.25956647146" },
  { id:"blue-apatite-tumble", name:"Blue Apatite", cat:"Tumbled Stones", intent:"Clarity",
    price:null, was:null, c1:"#6FB8D9", c2:"#2E6E93", img:"/assets/blue-apatite.jpg",
    blurb:"Sharpens focus & honest communication.", stock:"In stock", tag:"New",
    shopeePath:"CHEFFY-Blue-Apatite-Tumbled-Crystal-Gemstone-i.1496634.43611753554" },
  { id:"moonstone-raw", name:"Moonstone", cat:"Raw & Rough", intent:"Calm",
    price:null, was:null, c1:"#F0EDE6", c2:"#B8AFA0", img:"/assets/moonstone.jpg",
    blurb:"Soft, intuitive energy for new beginnings and gentle nights.", stock:"In stock", tag:"New",
    shopeePath:"CHEFFY-Moonstone-Raw-Big-Chunks-Crystal-i.1496634.21493235407" },
  { id:"red-jasper-tumble", name:"Red Jasper", cat:"Tumbled Stones", intent:"Confidence",
    price:null, was:null, c1:"#D9614F", c2:"#8B2E1F", img:"/assets/red-jasper.jpg",
    blurb:"Steady vitality & courage. Keeps your fire lit.", stock:"In stock", tag:"New",
    shopeePath:"CHEFFY-Red-Jasper-Crystal-Gemstone-Tumbled-Cube-i.1496634.23257420501" },
  { id:"black-obsidian-raw", name:"Black Obsidian", cat:"Raw & Rough", intent:"Protection",
    price:null, was:null, c1:"#3A3A44", c2:"#0A0A0D", img:"/assets/black-obsidian.jpg",
    blurb:"A mirror-sharp shield. Cuts through negativity and illusion.", stock:"In stock", tag:"New",
    shopeePath:"CHEFFY-Obsidian-Crystal-Gemstones-Raw-i.1496634.17484139876" },
];
...
export const faq = [
  ...
  { q:"Do you really start at ₱20?", a:"Yes, really! Small tumbled chips start at ₱20 so good energy is accessible to everyone. Shop our full lineup on Shopee or TikTok Shop for the same honest pricing." },
  ...
  { q:"Where are you based? Do you ship nationwide?", a:"We're based in Imus, Cavite and yes — we ship all over the Philippines via Shopee and TikTok Shop. Prefer to shop in person? Our collection is also carried by LunarSoul PH in Poblacion, Makati (open daily, 1PM–10PM). Same-day delivery via Lalamove is also available for nearby areas. DM us on Instagram for details!" },
  ...
  { q:"How do I order? Where can I buy Cheffy's Crystals?", a:"You can shop with us on Shopee (shopee.ph/cheffyyyy) or TikTok Shop (@cheffyscrystals) — secure checkout, buyer protection, and fast nationwide shipping on both. We also pop up at bazaars and events around Metro Manila — follow us on Instagram or TikTok so you never miss one!" },
];
...
export const blogs = [
  {
    ...
    imgAlt: "Wooden bowls of tumbled healing crystals arranged on a display table at a Philippine bazaar",
    read: "3 min read",
    date: "Jun 2026",
    isoDate: "2026-06-15",
    body: [
  ...
  },
  {
    ...
    img: "/assets/display-table.jpg",
    imgAlt: "An assortment of raw and tumbled crystals displayed in wooden bowls, ready to be styled at home",
    read: "3 min read",
    date: "Jun 2026",
    isoDate: "2026-06-08",
    body: [
  ...
  },
  {
    ...
    imgAlt: "Raw selenite wand crystal, a water-sensitive stone that should be cleansed dry",
    read: "3 min read",
    date: "Jun 2026",
    isoDate: "2026-06-01",
    body: [
  ...
  },
  {
    ...
    imgAlt: "Bowls of tumbled healing crystals with handwritten Philippine peso price labels",
    read: "2 min read",
    date: "May 2026",
    isoDate: "2026-05-20",
    body: [
  ...
  },
  {
    ...
    imgAlt: "Cluster of tumbled purple amethyst crystals, a classic starter stone for beginners",
    read: "4 min read",
    date: "May 2026",
    isoDate: "2026-05-05",
    body: [
  ...
  },
  {
    ...
    imgAlt: "Polished tiger's eye tumbled stones with golden-brown bands, a desk crystal for confidence",
    read: "4 min read",
    date: "Apr 2026",
    isoDate: "2026-04-20",
    body: [
  ...
  },
  {
    ...
    imgAlt: "Malachite gemstones showing deep green banded, swirling patterns",
    read: "4 min read",
    date: "Apr 2026",
    isoDate: "2026-04-01",
    body: [
